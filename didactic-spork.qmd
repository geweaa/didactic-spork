...
```{r files metag}
coverm <- read_tsv("data/mag/coverm.tsv.gz", col_types = cols(.default = col_character(), tpm = col_double()))

emapper <- read_tsv("data/mag/emapper.tsv.gz", show_col_types = FALSE) 
